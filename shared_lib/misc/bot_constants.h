...
public:
    ...
    static const unsigned int POSITION_SIZE = NUM_FLOATS_PER_POSITION *
                                              sizeof(float);
    static const unsigned int TEXCOORD_SIZE = NUM_FLOATS_PER_TEXCOORD *
                                              sizeof(float);
    ...
    static const unsigned int DIRECTION_SIZE = NUM_FLOATS_DIRECTION *
                                               sizeof(float);
